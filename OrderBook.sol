...
contract OrderBook is OrderBookSettings {
    ...
    function initialize(
        address _router, address _vault,
        address _weth, address _zkusd,
        uint256 _minExecutionFee, uint256 _minPurchaseTokenAmountUsd)
    external onlyGov {
        ...
        minExecutionFee = _minExecutionFee;
        minPurchaseTokenAmountUsd = _minPurchaseTokenAmountUsd;
        emit Events.Initialize(_router, _vault, _weth, _zkusd, _minExecutionFee, _minPurchaseTokenAmountUsd);
    }
